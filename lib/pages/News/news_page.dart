...
import 'package:wwe_universe/pages/news/news_detail_page.dart';
...
class NewsPageState extends State<NewsPage> with AutomaticKeepAliveClientMixin {
  ...
  Future refreshNews() async {
    ...
    newsList = await NewsDatabaseHelper.readAllNews();
  ...
  void setNewsList(String search) async {
    ...
    newsList = await NewsDatabaseHelper.readAllNewsSearch(search);
