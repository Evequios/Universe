...
class SuperstarsPage extends StatefulWidget{
  ...
  @override
  SuperstarsPageState createState() => SuperstarsPageState();
}

class SuperstarsPageState extends State<SuperstarsPage> with AutomaticKeepAliveClientMixin<SuperstarsPage> {
