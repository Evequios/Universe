...
import 'package:wwe_universe/widget/SuperstarsFormWidget.dart';
...
class _AddEditSuperstarsPage extends State<AddEditSuperstarsPage> {
  ...
  Future updateUniverseSuperstars() async {
    ...
    await DatabaseService.instance.updateSuperstar(superstar);
  }
  ...
  Future addUniverseSuperstars() async {
    ...
    await DatabaseService.instance.createSuperstar(superstar);
  }
}