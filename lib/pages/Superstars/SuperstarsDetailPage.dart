...
import 'package:wwe_universe/pages/Superstars/AddEditSuperstarsPage.dart';
...
class _SuperstarsDetailPage extends State<SuperstarsDetailPage> {
  ...
  Future refreshSuperstars() async {
    ...
    superstar = await DatabaseService.instance.readSuperstar(widget.superstarId);
    if(superstar.ally1 != 0) ally1 = await DatabaseService.instance.readSuperstar(superstar.ally1);
    if(superstar.ally2 != 0) ally2 = await DatabaseService.instance.readSuperstar(superstar.ally2);
    if(superstar.ally3 != 0) ally3 = await DatabaseService.instance.readSuperstar(superstar.ally3);
    if(superstar.ally4 != 0) ally4 = await DatabaseService.instance.readSuperstar(superstar.ally4);
    if(superstar.ally5 != 0) ally5 = await DatabaseService.instance.readSuperstar(superstar.ally5);

    if(superstar.rival1 != 0) rival1 = await DatabaseService.instance.readSuperstar(superstar.rival1);
    if(superstar.rival2 != 0) rival2 = await DatabaseService.instance.readSuperstar(superstar.rival2);
    if(superstar.rival3 != 0) rival3 = await DatabaseService.instance.readSuperstar(superstar.rival3);
    if(superstar.rival4 != 0) rival4 = await DatabaseService.instance.readSuperstar(superstar.rival4);
    if(superstar.rival5 != 0) rival5 = await DatabaseService.instance.readSuperstar(superstar.rival5);

    if(superstar.brand != 0) {
      brand = await DatabaseService.instance.readBrand(superstar.brand);
    } 
    else {
      brand = defaultBrand;
    }
    listBrands = await DatabaseService.instance.readAllBrands();
    listSuperstars = await DatabaseService.instance.readAllSuperstars();
    listMatches = await DatabaseService.instance.readAllMatchesSuperstar(superstar.id!);
  ...
  Future<int> getRecord() async {
    ...
    for(Matches m in listMatches){
      stip = await DatabaseService.instance.readStipulation(m.stipulation);
      switch(stip.type){
        case '2v2':
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s2)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s3)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s4)).id!);
          break;
        case '3v3':
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s2)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s3)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s4)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s5)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s6)).id!);
          break;
        case '4v4':
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s2)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s3)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s4)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s5)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s6)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s7)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s8)).id!);
          break;
        case '3-Way Tag':
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s2)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s3)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s4)).id!);
          team3.add((await DatabaseService.instance.readSuperstar(m.s5)).id!);
          team3.add((await DatabaseService.instance.readSuperstar(m.s6)).id!);
          break;  
        case '4-Way Tag':
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
          team1.add((await DatabaseService.instance.readSuperstar(m.s2)).id!);
          ...
          team3.add((await DatabaseService.instance.readSuperstar(m.s5)).id!);
          team3.add((await DatabaseService.instance.readSuperstar(m.s6)).id!);
          team4.add((await DatabaseService.instance.readSuperstar(m.s7)).id!);
          team4.add((await DatabaseService.instance.readSuperstar(m.s8)).id!);
          break;
        case 'Handicap 1v2' :
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s2)).id!);
          team2.add((await DatabaseService.instance.readSuperstar(m.s3)).id!);
          break;
        case'Handicap 1v3' : 
          team1.add((await DatabaseService.instance.readSuperstar(m.s1)).id!);
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed:  () async {
        await DatabaseService.instance.deleteSuperstar(widget.superstarId);
        if(context.mounted){
