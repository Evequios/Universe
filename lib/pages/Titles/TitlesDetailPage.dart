...
import 'package:wwe_universe/pages/Titles/TitlesReigns.dart';
import 'package:wwe_universe/pages/Titles/TitlesSetDivisions.dart';
...
class _TitlesDetailPage extends State<TitlesDetailPage> {
  ...
  Future refreshTitle() async {
    ...
    if(title.brand != 0) brand = await DatabaseService.instance.readBrand(title.brand);
    if(title.holder1 != 0) h1 = await DatabaseService.instance.readSuperstar(title.holder1);
    if(title.holder2 != 0) h2 = await DatabaseService.instance.readSuperstar(title.holder2);
    superstarsList = await DatabaseService.instance.readAllSuperstarsDivision(title.id!);
              ...
              children: [
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      await Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => TitlesReigns(titleId: title.id!,)),
                ...
                Material(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      await Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => TitlesSetDivisions(titleId: title.id!,)),
                      ).then((value) => refreshTitle());
                    }, 
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed:  () async {
        await DatabaseService.instance.deleteTitle(widget.titleId);
        if(context.mounted){
