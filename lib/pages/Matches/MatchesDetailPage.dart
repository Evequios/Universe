...
class _MatchesDetailPage extends State<MatchesDetailPage> {
  ...
  Future refreshMatches() async {
    ...
    match = await DatabaseService.instance.readMatch(widget.matchId);
    stipulation = await DatabaseService.instance.readStipulation(match.stipulation);
    if(match.titleId != 0) title = await DatabaseService.instance.readTitle(match.titleId!);
    s1 = await DatabaseService.instance.readSuperstar(match.s1);
    ...
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' ? s2 = await DatabaseService.instance.readSuperstar(match.s2) : null;
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' && stipulation.type != '1v1' ? s3 = await DatabaseService.instance.readSuperstar(match.s3) : null;
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' && stipulation.type != '1v1' && stipulation.type != 'Triple Threat' && stipulation.type != 'Handicap 1v2' ? s4 = await DatabaseService.instance.readSuperstar(match.s4) : null;
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' && stipulation.type != '1v1' && stipulation.type != 'Triple Threat' && stipulation.type != '2v2' && stipulation.type != 'Fatal 4-Way' && stipulation.type != 'Handicap 1v2' && stipulation.type != 'Handicap 1v3' ? s5 = await DatabaseService.instance.readSuperstar(match.s5) : null;
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' && stipulation.type != '1v1' && stipulation.type != 'Triple Threat' && stipulation.type != '2v2' && stipulation.type != 'Fatal 4-Way' && stipulation.type != '5-Way' && stipulation.type != 'Handicap 1v2' && stipulation.type != 'Handicap 1v3' && stipulation.type != 'Handicap 2v3' ? s6 = await DatabaseService.instance.readSuperstar(match.s6) : null;
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' && stipulation.type != '1v1' && stipulation.type != 'Triple Threat' && stipulation.type != '2v2' && stipulation.type != 'Fatal 4-Way' && stipulation.type != '5-Way' && stipulation.type != 'Handicap 1v2' && stipulation.type != 'Handicap 1v3' && stipulation.type != 'Handicap 2v3' && stipulation.type != '3v3' && stipulation.type != '3-Way Tag' && stipulation.type != '6-Way' ? s7 = await DatabaseService.instance.readSuperstar(match.s7) : null;
    stipulation.type != '10 Man' && stipulation.type != '20 Man' && stipulation.type != '30 Man' && stipulation.type != '1v1' && stipulation.type != 'Triple Threat' && stipulation.type != '2v2' && stipulation.type != 'Fatal 4-Way' && stipulation.type != '5-Way' && stipulation.type != 'Handicap 1v2' && stipulation.type != 'Handicap 1v3' && stipulation.type != 'Handicap 2v3' && stipulation.type != '3v3' && stipulation.type != '3-Way Tag' && stipulation.type != '6-Way' ? s8 = await DatabaseService.instance.readSuperstar(match.s8) : null;
    winner = await DatabaseService.instance.readSuperstar(match.winner);
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed:  () async {
        await DatabaseService.instance.deleteMatch(widget.matchId);
        if(context.mounted){
