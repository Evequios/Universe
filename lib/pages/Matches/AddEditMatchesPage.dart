...
class _AddEditMatchesPage extends State<AddEditMatchesPage> {
  ...
  Future updateUniverseMatches() async {
    ...
    if (checkedValue) {
      ...
      final idPreviousReign =
          await DatabaseService.instance.getPreviousReign(title.id!);
      final previousReign =
          await DatabaseService.instance.readReign(idPreviousReign!);

      if (previousReign.weekEnd == widget.show!.week &&
          previousReign.yearEnd == widget.show!.year &&
          winners.contains(previousReign.holder1)) {
  ...
  Future addUniverseMatches() async {
    ...
    if (checkedValue) {
      ...
      int? currentReign =
          await DatabaseService.instance.getCurrentReign(match.titleId!);
      if (currentReign != 0) {
        final reign = await DatabaseService.instance.readReign(currentReign!);
        reign.copy(yearEnd: widget.show!.year, weekEnd: widget.show!.week);
  ...
  Widget buildS1() => DropdownSearch<int>(
        ...
        items: listSuperstars.map((s1) => s1.id!).toList(),
  ...
  Future<List<int>> getWinnersList() async {
    ...
    if (soloType.contains(stip.type)) {
      ...
      switch (stip.type) {
        case '2v2':
          team1.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s1))
                  .id!);
          team1.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s2))
                  .id!);
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s3))
                  .id!);
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s4))
                  .id!);
          break;
        case '3v3':
          team1.add(
          ...
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s4))
                  .id!);
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s5))
                  .id!);
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s6))
                  .id!);
          break;
        case '4v4':
          team1.add(
          ...
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s6))
                  .id!);
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s7))
                  .id!);
          team2.add(
              (await DatabaseService.instance.readSuperstar(widget.match!.s8))
                  .id!);
          break;
        case '3-Way Tag':
          team1.add(
