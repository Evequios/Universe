...
import 'package:wwe_universe/widget/StorylinesFormWidget.dart';
...
class _AddEditStorylinesPage extends State<AddEditStorylinesPage> {
  ...
  Future updateUniverseStorylines() async {
    ...
    await DatabaseService.instance.updateStoryline(storyline);
  }
  ...
  Future addUniverseStorylines() async {
    ...
    await DatabaseService.instance.createStoryline(storyline);
  }
}