...
import 'package:wwe_universe/pages/Storylines/AddEditStorylinesPage.dart';
import 'package:wwe_universe/pages/Storylines/StorylinesDetailPage.dart';
...
class _StorylinesPage extends State<StorylinesPage> with AutomaticKeepAliveClientMixin {
  ...
  Future refreshStorylines() async {
    ...
    storylinesList = await DatabaseService.instance.readAllStorylines();
  ...
  void setStorylinesList(String search) async {
    ...
    storylinesList = await DatabaseService.instance.readAllStorylinesSearch(search);
