...
import 'package:wwe_universe/pages/Settings/Stipulations/AddEditStipulationsPage.dart';
import 'package:wwe_universe/pages/Settings/Stipulations/StipulationsDetailPage.dart';
...
class _StipulationsPageState extends State<StipulationsPage> with AutomaticKeepAliveClientMixin{
  ...
  void setStipulationsList(String search) async {
    ...
    stipulationsList = await DatabaseService.instance.readAllStipulationsSearch(search);
