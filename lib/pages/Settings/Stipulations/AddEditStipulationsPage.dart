...
import 'package:wwe_universe/widget/StipulationsFormWidget.dart';
...
class _AddEditStipulationsPage extends State<AddEditStipulationsPage> {
  ...
  Future updateUniverseStipulations() async {
    ...
    await DatabaseService.instance.updateStipulation(stipulation);
  }
  ...
  Future addUniverseStipulations() async {
    ...
    await DatabaseService.instance.createStipulation(stipulation);
  }
}