...
import 'package:wwe_universe/pages/Teams/TeamsDetailPage.dart';
...
class _TeamsPageState extends State<TeamsPage> with AutomaticKeepAliveClientMixin {
  ...
  Future refreshTeams() async {
    ...
    teamsList = await DatabaseService.instance.readAllTeams();
  ...
  void setTeamsList(String search) async {
    ...
    teamsList = await DatabaseService.instance.readAllTeamsSearch(search);
