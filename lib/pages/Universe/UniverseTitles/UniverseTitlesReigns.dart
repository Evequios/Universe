...
class UniverseTitlesReigns extends StatefulWidget{
  final int titleId;
  const UniverseTitlesReigns({super.key, required this.titleId});

  @override
  _UniverseTitlesReignsState createState() => _UniverseTitlesReignsState();
}

class _UniverseTitlesReignsState extends State<UniverseTitlesReigns> with AutomaticKeepAliveClientMixin {
  late List<UniverseReigns> reignsList;
  UniverseSuperstars holder1 = UniverseSuperstars(name: 'name', brand: 0, orientation: 'orientation', ally1: 0, ally2: 0, ally3: 0, ally4: 0, ally5: 0, rival1: 0, rival2: 0, rival3: 0, rival4: 0, rival5: 0, division: 0);
  UniverseSuperstars holder2 = UniverseSuperstars(name: 'name', brand: 0, orientation: 'orientation', ally1: 0, ally2: 0, ally3: 0, ally4: 0, ally5: 0, rival1: 0, rival2: 0, rival3: 0, rival4: 0, rival5: 0, division: 0);
  ...
  Future refreshReigns() async {
    ...
    reignsList = await UniverseDatabase.instance.readAllReignsTitle(widget.titleId);
